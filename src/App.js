...
const API_KEY = "api_key=9b0417863cdfaed9f980390a91451bad"; 
const SEARCH_URL="search/movie?language=fr&include_adult=true";
...
class App extends Component {
  ...
  applyVideoToCurrentMovie(){
    axios.get(`${API_END_POINT}movie/${this.state.currentMovie.id}?${API_KEY}&include_adult=false&append_to_response=videos`).then(function(response){
      if(response.data && response.data.videos && response.data.videos.results[0]){
